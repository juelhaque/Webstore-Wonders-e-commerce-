    ...
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <picture>
                    <source media="(max-width: 799px)" srcset="{{ asset('front-assets/images/computer.jpg') }}" />
                    <source media="(min-width: 800px)" srcset="{{ asset('front-assets/images/computer.jpg') }}" />
                    <img src="{{ asset('front-assets/images/computer.jpg') }}" alt="" />
                </picture>
            ...
            <div class="carousel-item">
                ...
                <picture>
                    <source media="(max-width: 799px)" srcset="{{ asset('front-assets/images/watch.jpg') }}" />
                    <source media="(min-width: 800px)" srcset="{{ asset('front-assets/images/watch.jpg') }}" />
            ...
            <div class="carousel-item">
                ...
                <picture>
                    <source media="(max-width: 799px)" srcset="{{ asset('front-assets/images/electronics1-1.jpg') }}" />
                    <source media="(min-width: 800px)" srcset="{{ asset('front-assets/images/electronics1-1.jpg') }}" />
                    <img src="{{ asset('front-assets/images/electronics1-1.jpg') }}" alt="" />
                </picture>
            ...
            @if (getCategories()->isNotEmpty())
                ...
                <div class="col-lg-3">
                    <a href="{{ route('front.shop') }}">
                        <div class="cat-card" style="border-radius: 10px">
                            <div class="left">
                                @if ($category->image != "")
