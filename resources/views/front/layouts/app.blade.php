            ...
            <div class="row align-items-center py-2 d-none d-lg-flex justify-content-between">
                <div class="col-lg-4 logo">
                    <a href="{{ route('front.home') }}" class="text-decoration-none">
                        ...
                        <img src="{{ asset('front-assets/images/Webstore wonders.jpg') }}" alt="logo" style="height: 50px; width: 50%;">
                ...
                <div class="row">
                    <div class="col-12 mt-3">
                        <div class="copy-right text-center">
                            <p>© Copyright {{ date('Y') }} Webstore Wonders. All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
